...
import { ChartLocalidad, ConsultaVisita, RuiLocalidad, RuiSector, RuidoLocalidad } from '../modelos/ruido.interface';
...
export class LocalidadService {
  ...
  //*******************
  consultaLocalidad(localidad: RuiLocalidad): Observable<RuidoLocalidad[]> {
    ...
    return this.http.post<RuidoLocalidad[]>(direccion, localidad, {
